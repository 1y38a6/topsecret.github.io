...
var prepromise = [
    ...
    "Здесь написано что ты солнышко.. а ещё..",
    // "Здесь ещё много пасхалок на самом деле, но сейчас тебе стоит знать, что...",
    "Пока идет загрузка, в отражении экрана ты можешь лицезреть самую милую девочку в этом мире ♥",
    "Я люблю тебя"
    ];
...
function LoadDates()
{
  ...
  AddPredictions(
    "28/06/2021",
    [
      "не ожидала увидеть это?))<br>во-первых, приятного аппетита *чмок*",
      'во-вторых, я хотел тебе напомнить о том, как много вместе мы пережили, как сильно изменились, как много осознали.. столько слёз горя и счастья, столько достяжений. Это было сложно, но посмотри кто мы теперь, как мы стали близки, как мы рады тому, что друг у друга есть<div class="lds-heart"><div></div></div></div>',
      'встреча с тобой спасла меня. мне был противен весь этот мир, я так устал от людей и тут явилась ты. не такая как другие. такая чистая, искреняя, не желающая никакой наживы, добродушная.. ты открылась мне, зная, что это может сломать тебя. предпочла рискнуть, а я открылся тебе в ответ',
      'все эти события на меня сильно повлияли. я действительно сильно изменился. изменились приоритеты, изменилось отношение к жизни. время, проведенное с тобой прекрасно, понимаю, что хочу чтобы мы были вместе всегда, ведь я безумно люблю тебя',
      'так вот, что бы не случилось, солнышко, знай, что ты можешь рассчитывать на меня. вместе мы справимся со всем<br>♥'
    ]
  );
  ...
  AddPredictions(
    ...
    [
      ...
      "тут так много записей.. наверное, это самое прекрасное, что я когда-либо делал",
      "вероятно, некоторые записи ты не видела, но знай, что я никогда тебя не разлюблю, ведь эти чувства - это то, чего я хочу, самое прекрасное, что происходило со мной",
      "ты инициатор моих прекрасных чувств, я правда благодарен тебе за то, что даешь возможность это чувствовать",
      "спасибо, что даешь мне право на ошибку, что говоришь со мной. для меня это действительно очень важно, важно каждое твое слово, каждая твоя эмоция",
      "я безумно сильно люблю тебя",
      "мы будем счастливы вместе, у нас получится справится со всеми преградами, ведь что бы не произошло, я все-равно люблю тебя",
      "моя любовь к тебе - это единственное, в чем я действительно уверен на 100%<br>я не так сильно уверен в том, что являюсь программистом, как в том, что люблю тебя"
    ]
  );
}
